...
private wiki exports, and secrets outside Git. Trusted local UI, REST, CLI, MCP,
diagnostic, audit and search surfaces may expose useful retained-derived runtime
data; this does not make that data suitable for Git, export or sharing.
