...
1. Run the V2.8 reliability benchmark harness on real high-volume roots to tune
   native watcher compatibility, hash parallelism, and worker-cap defaults from
   observed hardware evidence.
2. Extend V2.8 throughput benchmarks with model warm/cold telemetry across
   deployment updates.
