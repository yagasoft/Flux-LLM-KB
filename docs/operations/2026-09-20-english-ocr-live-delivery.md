...
This is the complete cumulative change from the main baseline, including useful
earlier authorised document-processing/probe work retained on this branch.
It is not a claim that every file was newly authored during the final OCR run.

```text
Directory.Packages.props
docs/architecture.md
docs/operations/2026-09-19-english-ocr-screening.md
docs/operations/2026-09-20-english-ocr-benchmark-execution.md
docs/operations/2026-09-20-english-ocr-live-delivery.md
docs/operations/2026-09-20-english-ocr-practical-assessment.md
docs/operations/document-ocr-acquisition-proposal.md
docs/operations/english-ocr-onnx-acquisition-proposal.md
docs/operations/english-ocr-onnx-preflight-acquisition.json
docs/operations/english-ocr-onnx-preflight-acquisition.md
docs/operations/english-ocr-paddle-runtime.draft.json
docs/operations/english-ocr-ppstructure-onnx-artifacts.draft.json
docs/operations/english-ocr-update-proposal.md
docs/roadmap.md
docs/superpowers/plans/2026-09-18-document-processors.md
docs/superpowers/plans/2026-09-19-visio-ocr-delivery.md
docs/superpowers/specs/2026-08-13-phase-5-office-document-amendment-design.md
docs/superpowers/specs/2026-09-18-document-processors-design.md
docs/superpowers/specs/2026-09-19-visio-ocr-delivery-design.md
probes/ocr-quality-assessment/HarnessSelfTests.cs
probes/ocr-quality-assessment/OcrQualityAssessment.csproj
probes/ocr-quality-assessment/Program.cs
probes/ocr-quality-assessment/README.md
probes/ocr-quality-assessment/packages.lock.json
probes/paddleocr-vl-benchmark/paddleocr_vl_driver.py
probes/paddleocr-vl-benchmark/paddleocr_vl_driver_tests.py
probes/ppstructure-onnx-benchmark/BundleManifest.cs
probes/ppstructure-onnx-benchmark/PpStructureOnnxBenchmark.csproj
probes/ppstructure-onnx-benchmark/ProbeVerificationFiles.cs
probes/ppstructure-onnx-benchmark/Program.cs
probes/ppstructure-onnx-benchmark/packages.lock.json
probes/ppstructure-onnx-benchmark/ppstructure_driver.py
probes/ppstructure-onnx-benchmark/ppstructure_driver_tests.py
probes/tesseract-text-baseline/Program.cs
probes/tesseract-text-baseline/README.md
probes/tesseract-text-baseline/RunnerSelfTests.cs
probes/tesseract-text-baseline/TesseractBenchmarkRunner.cs
probes/tesseract-text-baseline/TesseractTextBaseline.csproj
probes/tesseract-text-baseline/packages.lock.json
src/FluxKnowledge.Application/Documents/DocumentExtractionResult.cs
src/FluxKnowledge.Application/Documents/DocumentOcrProvenance.cs
src/FluxKnowledge.Application/Documents/DocumentProcessingInput.cs
src/FluxKnowledge.Application/Documents/IDocumentOcrExecutor.cs
src/FluxKnowledge.Application/Documents/IDocumentOcrHandoff.cs
src/FluxKnowledge.Application/Documents/IDocumentOcrModelResolver.cs
src/FluxKnowledge.Application/Documents/IDocumentOcrResultReader.cs
src/FluxKnowledge.Application/Documents/IPdfDocumentExtractor.cs
src/FluxKnowledge.Application/Documents/IPdfPageRasterizer.cs
src/FluxKnowledge.Application/Documents/PaddleOcrVlmRuntimeContract.cs
src/FluxKnowledge.Application/Documents/VsdxDocumentExtractor.cs
src/FluxKnowledge.Application/Gpu/GpuSchedulerContracts.cs
src/FluxKnowledge.Application/Indexing/CanonicalIndexStageWorker.cs
src/FluxKnowledge.Application/Models/ILocalModelStore.cs
src/FluxKnowledge.Application/Pipeline/StageTransitionRequest.cs
src/FluxKnowledge.Application/Ports/IRetainedProcessorBranchStore.cs
src/FluxKnowledge.Application/Sources/OoxmlStructuralTextProcessor.cs
src/FluxKnowledge.Application/Sources/PdfDocumentProcessor.cs
src/FluxKnowledge.Application/Sources/RetainedProcessorActivationService.cs
src/FluxKnowledge.Application/Sources/RetainedTextActivityPlanner.cs
src/FluxKnowledge.Application/Sources/SourceClassifier.cs
src/FluxKnowledge.Application/Sources/ZipArchiveRetainedProcessor.cs
src/FluxKnowledge.Application/Workers/ExtractDocumentStageWorker.cs
src/FluxKnowledge.Application/Workers/IStageWorker.cs
src/FluxKnowledge.Application/Workers/NormaliseTextStageWorker.cs
src/FluxKnowledge.Cli/Commands/DocumentReprocessCommand.cs
src/FluxKnowledge.Cli/Program.cs
src/FluxKnowledge.Cli/packages.lock.json
src/FluxKnowledge.Infrastructure.Inference/Documents/CtcTextDecoder.cs
src/FluxKnowledge.Infrastructure.Inference/Documents/DirectMlDocumentOcrSessionFactory.cs
src/FluxKnowledge.Infrastructure.Inference/Documents/DocumentOcrGeometry.cs
src/FluxKnowledge.Infrastructure.Inference/Documents/DocumentOcrModelBundleResolver.cs
src/FluxKnowledge.Infrastructure.Inference/Documents/DocumentOcrModelConfiguration.cs
src/FluxKnowledge.Infrastructure.Inference/Documents/DocumentOcrRuntime.cs
src/FluxKnowledge.Infrastructure.Inference/Documents/NativeDocumentOcrEngine.cs
src/FluxKnowledge.Infrastructure.Inference/FluxKnowledge.Infrastructure.Inference.csproj
src/FluxKnowledge.Infrastructure.Inference/packages.lock.json
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Configurations/CanonicalSchemaConfigurations.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/DocumentOcrRequestState.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Entities/ArtifactEntity.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Entities/DocumentOcrRequestEntity.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Entities/DocumentPublicationEntity.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/FluxKnowledgeDbContext.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Migrations/20260918193207_AddDocumentPublicationSelector.Designer.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Migrations/20260918193207_AddDocumentPublicationSelector.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Migrations/20260920122758_AddDocumentOcrRequestsAndArtifactMetadata.Designer.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Migrations/20260920122758_AddDocumentOcrRequestsAndArtifactMetadata.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/Migrations/FluxKnowledgeDbContextModelSnapshot.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlCorpusProjectionReader.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlDocumentOcrStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlGpuSchedulerStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlJobClaimStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlNativeOperationStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlPipelineStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlRetainedProcessorBranchStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlRetainedTextRegistrationStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlSourceDeletionStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Persistence/SqlStageTransitionStore.cs
src/FluxKnowledge.Infrastructure.SqlServer/Search/SqlFullTextSearch.cs
src/FluxKnowledge.Infrastructure.SqlServer/Search/SqlSearchHydrator.cs
src/FluxKnowledge.Infrastructure.SqlServer/Workers/OutboxWorkerRegistration.cs
src/FluxKnowledge.Infrastructure.SqlServer/Workers/PaddleOcrVlmCompletionCoordinator.cs
src/FluxKnowledge.Infrastructure.SqlServer/Workers/PaddleOcrVlmExecutionRegistry.cs
src/FluxKnowledge.Infrastructure.SqlServer/Workers/PaddleOcrVlmExecutorAdapter.cs
src/FluxKnowledge.Infrastructure.SqlServer/Workers/PaddleOcrVlmLocalRuntimeServices.cs
src/FluxKnowledge.Infrastructure.SqlServer/packages.lock.json
src/FluxKnowledge.Integrations/Documents/PaddleOcrVlmLocalExecutor.cs
src/FluxKnowledge.Integrations/Documents/SyncfusionLicenceRegistration.cs
src/FluxKnowledge.Integrations/Documents/SyncfusionPdfDocumentExtractor.cs
src/FluxKnowledge.Integrations/Documents/SyncfusionPdfPageRasterizer.cs
src/FluxKnowledge.Integrations/Documents/paddleocr_vl_executor.py
src/FluxKnowledge.Integrations/FluxKnowledge.Integrations.csproj
src/FluxKnowledge.Integrations/Models/FixedDocumentOcrManifestReader.cs
src/FluxKnowledge.Integrations/Models/PaddleOcrVlmModelGate.cs
src/FluxKnowledge.Integrations/Properties/AssemblyInfo.cs
src/FluxKnowledge.Integrations/Windows/NativeGoLive/HandleRelativeNativeFileSystem.ModelStore.cs
src/FluxKnowledge.Integrations/packages.lock.json
src/FluxKnowledge.OutlookHost/packages.lock.json
src/FluxKnowledge.Web/Configuration/NativeGoLiveRuntimeOptions.cs
src/FluxKnowledge.Web/WebHostComposition.cs
src/FluxKnowledge.Web/packages.lock.json
tests/FluxKnowledge.Domain.Tests/Documents/CtcTextDecoderTests.cs
tests/FluxKnowledge.Domain.Tests/Documents/DocumentOcrGeometryTests.cs
tests/FluxKnowledge.Domain.Tests/Documents/DocumentOcrModelBundleResolverTests.cs
tests/FluxKnowledge.Domain.Tests/Documents/DocumentOcrProvenanceTests.cs
tests/FluxKnowledge.Domain.Tests/Documents/DocumentOcrRuntimeTests.cs
tests/FluxKnowledge.Domain.Tests/Documents/PdfDocumentProcessingTests.cs
tests/FluxKnowledge.Domain.Tests/FluxKnowledge.Domain.Tests.csproj
tests/FluxKnowledge.Domain.Tests/Pipeline/StageWorkerTests.cs
tests/FluxKnowledge.Domain.Tests/Sources/OoxmlStructuralTextProcessorTests.cs
tests/FluxKnowledge.Domain.Tests/Sources/SourceClassifierTests.cs
tests/FluxKnowledge.Domain.Tests/Sources/ZipArchiveRetainedProcessorTests.cs
tests/FluxKnowledge.Domain.Tests/packages.lock.json
tests/FluxKnowledge.Integration.Tests/Cli/DocumentReprocessCommandTests.cs
tests/FluxKnowledge.Integration.Tests/Documents/PaddleOcrVlmLocalExecutorTests.cs
tests/FluxKnowledge.Integration.Tests/Documents/SqlDocumentOcrHandoffTests.cs
tests/FluxKnowledge.Integration.Tests/Gpu/SqlGpuTaskHandoffTests.cs
tests/FluxKnowledge.Integration.Tests/Models/DocumentOcrLocalModelCompatibilityTests.cs
tests/FluxKnowledge.Integration.Tests/Models/DocumentOcrModelConfigurationTests.cs
tests/FluxKnowledge.Integration.Tests/Models/FixedDocumentOcrManifestReaderTests.cs
tests/FluxKnowledge.Integration.Tests/Models/LocalModelStoreTests.cs
tests/FluxKnowledge.Integration.Tests/Models/PaddleOcrVlmModelGateTests.cs
tests/FluxKnowledge.Integration.Tests/Persistence/DocumentPublicationIntegrationTests.cs
tests/FluxKnowledge.Integration.Tests/Persistence/SchemaMappingTests.cs
tests/FluxKnowledge.Integration.Tests/Search/HybridSearchIntegrationTests.cs
tests/FluxKnowledge.Integration.Tests/Sources/CorpusProjectionIntegrationTests.cs
tests/FluxKnowledge.Integration.Tests/Sources/RetainedTextPipelineIntegrationTests.cs
tests/FluxKnowledge.Integration.Tests/Sources/SourceDeletionIntegrationTests.cs
tests/FluxKnowledge.Integration.Tests/Sources/ZipArchiveReplayIntegrationTests.cs
tests/FluxKnowledge.Integration.Tests/Support/NativeSqlServerFixture.cs
tests/FluxKnowledge.Integration.Tests/Support/SqlTestData.cs
tests/FluxKnowledge.Integration.Tests/Workers/OutboxPumpTests.cs
tests/FluxKnowledge.Integration.Tests/packages.lock.json
tests/FluxKnowledge.OutlookHost.Tests/packages.lock.json
