...
SETTING_REGISTRY: tuple[SettingDefinition, ...] = (
    ...
    SettingDefinition(
        ...
        default=False,
        value_type="bool",
        description="Enable future opt-in Windows Volume Shadow Copy fallback for locked local NTFS files.",
    ...
    SettingDefinition(
        ...
        value_type="int",
        description="Maximum file size eligible for future VSS fallback attempts.",
    ...
    SettingDefinition(
        ...
        default=30,
        value_type="int",
        description="Maximum time budget for future VSS fallback attempts.",
