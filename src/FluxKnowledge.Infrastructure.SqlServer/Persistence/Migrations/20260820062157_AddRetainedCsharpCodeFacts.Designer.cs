...
namespace FluxKnowledge.Infrastructure.SqlServer.Persistence.Migrations
{
    ...
    [Migration("20260820062157_AddRetainedCsharpCodeFacts")]
    partial class AddRetainedCsharpCodeFacts
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FluxKnowledge.Infrastructure.SqlServer.Persistence.Entities.SourceProcessorCodeDocumentEntity", b =>
                {
                    ...
                    b.ToTable("SourceProcessorCodeDocuments", null, t =>
                        {
                            t.HasCheckConstraint("CK_SourceProcessorCodeDocuments_Counts", "[DecodedCharacterCount] >= 0 AND [LineCount] >= 0 AND [SymbolCount] >= 0 AND [ReferenceCount] >= 0 AND [DiagnosticsCount] BETWEEN 0 AND 256 AND [WithheldSymbolCount] >= 0 AND [WithheldReferenceCount] >= 0 AND [WithheldDiagnosticCount] BETWEEN 0 AND 256 AND [ReceiptDiagnosticCodeCount] BETWEEN 0 AND 256");
                        });
                });
            ...
            modelBuilder.Entity("FluxKnowledge.Infrastructure.SqlServer.Persistence.Entities.SourceProcessorCodeReferenceEntity", b =>
                {
                    ...
                    b.ToTable("SourceProcessorCodeReferences", null, t =>
                        {
                            t.HasCheckConstraint("CK_SourceProcessorCodeReferences_Bounds", "[Ordinal] >= 0 AND [RelationshipKindCode] >= 0 AND [SpanStartUtf16] >= 0 AND [SpanLengthUtf16] >= 0");
                        });
                });
            ...
            modelBuilder.Entity("FluxKnowledge.Infrastructure.SqlServer.Persistence.Entities.SourceProcessorCodeSymbolEntity", b =>
                {
                    ...
                    b.ToTable("SourceProcessorCodeSymbols", null, t =>
                        {
                            t.HasCheckConstraint("CK_SourceProcessorCodeSymbols_Bounds", "[Ordinal] >= 0 AND [DeclarationKindCode] >= 0 AND [SpanStartUtf16] >= 0 AND [SpanLengthUtf16] >= 0 AND [LexicalParentOrdinal] >= -1");
                        });
                });
