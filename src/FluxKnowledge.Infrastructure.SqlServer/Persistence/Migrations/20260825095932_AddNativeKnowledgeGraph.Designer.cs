...
namespace FluxKnowledge.Infrastructure.SqlServer.Persistence.Migrations
{
    ...
    [Migration("20260825095932_AddNativeKnowledgeGraph")]
    partial class AddNativeKnowledgeGraph
    {
        /// <inheritdoc />
                    ...
                    b.ToTable("KnowledgeClaims", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_KnowledgeClaims_ContentShape", "([ForgottenAtUtc] IS NULL AND LEN([CanonicalIdentity]) > 0 AND LEN([Subject]) > 0 AND LEN([Predicate]) > 0 AND LEN([ObjectText]) > 0) OR ([ForgottenAtUtc] IS NOT NULL AND [CanonicalIdentity] = N'' AND [Subject] = N'' AND [Predicate] = N'' AND [ObjectText] = N'')");
            ...
            modelBuilder.Entity("FluxKnowledge.Infrastructure.SqlServer.Persistence.Entities.KnowledgeItemEntity", b =>
                {
                    ...
                    b.HasIndex("ForgottenAtUtc");

                    b.ToTable("KnowledgeItems", null, t =>
                        {
                            t.HasCheckConstraint("CK_KnowledgeItems_ContentShape", "([ForgottenAtUtc] IS NULL AND LEN([Title]) > 0 AND LEN([SafeBody]) > 0) OR ([ForgottenAtUtc] IS NOT NULL AND [Title] = N'' AND [SafeBody] = N'')");
                        });
                });
