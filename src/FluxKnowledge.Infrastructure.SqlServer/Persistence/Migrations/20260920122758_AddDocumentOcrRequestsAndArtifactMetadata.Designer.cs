...
namespace FluxKnowledge.Infrastructure.SqlServer.Persistence.Migrations
{
    ...
    [Migration("20260920122758_AddDocumentOcrRequestsAndArtifactMetadata")]
    partial class AddDocumentOcrRequestsAndArtifactMetadata
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FluxKnowledge.Infrastructure.SqlServer.Persistence.Entities.SourceDeletionCleanupItemEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<Guid>("SourceDeletionOperationId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("SourceDeletionOperationId", "StorageKind", "RelativePath")
                        .IsUnique();

                    b.ToTable("SourceDeletionCleanupItems", null, t =>
                        {
                            t.HasCheckConstraint("CK_SourceDeletionCleanupItems_ByteLength", "[ByteLength] IS NULL OR [ByteLength] >= 0");

                            t.HasCheckConstraint("CK_SourceDeletionCleanupItems_ContentSha256", "[ContentSha256] IS NULL OR ([ContentSha256] NOT LIKE '%[^0-9a-f]%' AND LEN([ContentSha256]) = 64)");

                            t.HasCheckConstraint("CK_SourceDeletionCleanupItems_State", "[State] IN (0, 1, 2)");

                            t.HasCheckConstraint("CK_SourceDeletionCleanupItems_StorageKind", "[StorageKind] IN (1, 2)");
                        });
                });

            modelBuilder.Entity("FluxKnowledge.Infrastructure.SqlServer.Persistence.Entities.SourceDeletionOperationEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int>("PipelineRecordCount")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SharedArtifactCount")
                        .HasColumnType("int");

                    b.Property<int>("SourceArtifactCount")
                        .HasColumnType("int");
                    ...
                    b.ToTable("SourceDeletionOperations", (string)null);
                });
            ...
            modelBuilder.Entity("FluxKnowledge.Infrastructure.SqlServer.Persistence.Entities.SourceDeletionCleanupItemEntity", b =>
                {
                    b.HasOne("FluxKnowledge.Infrastructure.SqlServer.Persistence.Entities.SourceDeletionOperationEntity", "SourceDeletionOperation")
                        .WithMany()
                        .HasForeignKey("SourceDeletionOperationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("SourceDeletionOperation");
                });
